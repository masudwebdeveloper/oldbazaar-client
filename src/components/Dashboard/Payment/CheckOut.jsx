                        ...
                        <div class="mx-auto max-w-lg px-4 lg:px-8">
                            ...
                            <div class="mt-12">
                                ...
                                <div className='mt-12'>
                                    {
                                        success && <>
                                            <h1 className='text-2xl text-green-600 font-semibold italic'>{success}</h1>
                                            <p className='text-2xl text-gray-500 font-mono'>Please note your TransactionId :- <strong>{transactinId}</strong>!</p>
                                        </>
                                    }
