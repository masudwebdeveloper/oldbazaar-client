          ...
          <div class="lg:col-span-2">
            <div class="mt-8 text-center">
              <a href="" class="text-6xl font-bold text-pink-700">
                <div className="w-12 h-12 rounded-full text-6xl border-dashed animate-spin border-4 border-orange-400 ml-10"></div>
                LDB<span className="text-pink-500">azaar</span>
              </a>{" "}
              <br />
            ...
            <img
              src="https://i.pcmag.com/imagery/lineups/02hOB8SkvCC7nUU4C9v3VQP-1.fit_lim.size_768x432.v1569492844.jpg"
              alt=""
            />
            <img
              src="https://i.dawn.com/primary/2021/08/6118938e06547.png"
              alt=""
            />
          </div>
