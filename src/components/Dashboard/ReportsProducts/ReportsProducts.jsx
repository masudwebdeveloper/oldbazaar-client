          ...
          {reports.length > 0 &&
            reports.map((report, i) => (
              <tr key={report._id}>
                ...
                <td class="whitespace-nowrap px-4 py-2 text-gray-700">
                  <strong>{report.productId}</strong>
                </td>
                <td class="whitespace-nowrap px-4 py-2 text-red-700 bg-gray-200 text-xl font-bold text-center">
