          ...
          {users.length > 0 &&
            users.map((user, i) => (
              <tr key={user._id}>
                ...
                <td class="whitespace-nowrap px-4 py-2 bg-green-500 text-slate-100 font-bold text-lg">
                  {user?.role === "Seller" && user?.role}
                </td>
                <td class="whitespace-nowrap px-4 py-2 bg-orange-400 text-slate-100 font-bold text-lg">
                  {user?.role === "Buyer" && user?.role}
                </td>
                {user?.role !== "admin" ? (
                  <td class="whitespace-nowrap px-4 py-2">
                    <button
                      onClick={() => handleUserMakeAdmin(user)}
