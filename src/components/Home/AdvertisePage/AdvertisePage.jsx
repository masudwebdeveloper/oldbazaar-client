    ...
    <section className=''>
      <div class="mx-auto max-w-screen-xl px-4 py-8">
        <div class="relative mx-auto max-w-3xl text-center">
          ...
          {/* <h2 class="relative inline-block bg-white px-4 text-center text-2xl font-bold"></h2> */}
        </div>
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-8">
          {adveritse.map((product) => (
            <a href="##" class="relative block border border-gray-100">
              ...
              <div class="p-6">
                <p class="text-sm font-medium text-gray-900 bg-orange-400">
                  Resale Price: {product.resalePirce}
                </p>
                <p class="text-sm font-medium text-gray-600 underline decoration-amber-400">
                ...
                <div className="flex ">
                  ...
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="w-6 h-6 text-green-600 ml-5"
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
