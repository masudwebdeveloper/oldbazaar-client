...
import bannerPhoto from "../../../assets/images/landing-page-apple-phone.png";
  ...
  return (
    <div className="bg-[#F9F3F0]">
      <section className="flex h-screen w-full justify-between items-center px-8 max-w-[1350px] mx-auto -z-50">
        ...
        <div
          style={{ backgroundImage: `url('images/shape-1.png')` }}
          className="relative hidden h-[450px] w-[450px] transition-all duration-500 md:inline lg:h-[650px] lg:w-[600px] lg:mt-20 bg-no-repeat z-10 bg-bottom"
        >
          <img
            alt=""
            src={bannerPhoto}
