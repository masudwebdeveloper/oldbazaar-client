        ...
        <section className='mx-auto max-w-screen-xl px-4 py-8'>
            <div>
                <div className='flex flex-col lg:flex-row justify-between bg-slate-200 p-5'>
                    <button className='btn btn-ghost'>Oppo</button>
                    <button className='btn btn-ghost'>Vivo</button>
                    <button className='btn btn-ghost'>Realme</button>
                    <button className='btn btn-ghost'>Samsung</button>
