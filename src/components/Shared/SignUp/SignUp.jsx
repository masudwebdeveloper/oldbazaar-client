...
const SignUp = () => {
  ...
  const handleSignUp = (data) => {
    ...
    if (password !== password_confirmation) {
      setPasswordMatch("Your password is dont match try again");
      return;
    }

    console.log(fullName, email, password_confirmation);
          ...
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              <p className="mt-4 leading-relaxed text-gray-500">
                No one has the power to shatter your dreams unless you give it
                to them.
              </p>
            </div>
            ...
            >
              ...
              <div className="col-span-6">
                ...
                <input
                  ...
                  name="email"
                  className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                  {...register("email", { required: "Email Fill is Required" })}
              ...
              <div className="col-span-6 sm:col-span-3">
                ...
                {passwordMatch && (
                  <p className="text-red-600">{passwordMatch}</p>
                )}
                {signUpError && (
